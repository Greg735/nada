...
class DefaultAuth implements AuthInterface
{
	...
	function edit_profile()
	{
    	...
    	$this->ci->form_validation->set_rules('first_name', t('first_name'), 'trim|required|html_escape|max_length[50]');
    	$this->ci->form_validation->set_rules('last_name', t('last_name'), 'trim|required|html_escape|max_length[50]');
    	$this->ci->form_validation->set_rules('phone', t('phone'), 'trim|html_escape|max_length[20]');
    	$this->ci->form_validation->set_rules('company', t('company'), 'trim|html_escape|max_length[100]');
		$this->ci->form_validation->set_rules('country', t('country'), 'trim|html_escape|max_length[100]');
	...
	*/
	...
	function change_password()
	{
	    ...
	    $this->ci->form_validation->set_rules('old', t('old_password'), 'required|max_length[20]|html_escape');
	...
	{
		$this->disable_page_cache();
		$this->ci->form_validation->set_rules('email', t('email'), 'trim|required|html_escape|max_length[100]');
	...
	{		
    	...
    	//$this->ci->form_validation->set_rules('phone1', t('phone'), 'trim|html_escape|max_length[20]');
    	//$this->ci->form_validation->set_rules('company', t('company'), 'trim|html_escape|max_length[100]');
		$this->ci->form_validation->set_rules('country', t('country'), 'trim|html_escape|max_length[150]|check_user_country_valid');
	...
	function verify_code()
	{
		...
		$this->ci->form_validation->set_rules('code', t('verification_code'), 'trim|required|html_escape|max_length[10]');
